...
function App() {
  ...
  useEffect(function () {
    async function fetchData() {
      ...
      try {
        const response = await fetch("http://localhost/goals"); // With or without docker network; react runs in browser
  ...
  async function addGoalHandler(goalText) {
    ...
    try {
      // With or without docker network; react runs in browser
